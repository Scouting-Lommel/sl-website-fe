...
export default function leaders({fin, general, leaderList}){
    return (<Layout generalData={general} title="Leiding" url="" noIndex={true}>
        {leaderList.map((component, i) => {
            return <ItemCarousel info={fin[i]} key={"Takken" + i} leaders={component}/>
        })}
    </Layout>)
}
...
export async function getStaticProps() {
    ...
    let leaderList = [KapoenenLeiding, WelpenLeiding, AkabeLeiding, JonggiverLeiding, GiverLeiding, JinLeiding]
    let fin = [{Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Kapoenen"},
    {Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Welpen"},
    {Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Akabe"},
    {Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Jonggivers"},
    {Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Givers"},
    {Items: [], IsLeaderShowcase: true, IsGroupsShowcase: false, Title:"Jin"}]
