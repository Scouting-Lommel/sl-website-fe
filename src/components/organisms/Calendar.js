    ...
    return(
        ...
        <div className="pb-3 px-36">
            <div className="flex justify-between">
                ...
                <div>
                    {/* prev month button */}
                    <button onClick={() => prevMonth(getMonth, setMonth, getYear, setYear, setDayList, getRentedDayList)}>
                        Prev
                ...
                <div>
                    {/* next month button */}
                    <button onClick={() => nextMonth(getMonth, setMonth, getYear, setYear, setDayList, getRentedDayList)}>
                        Next
