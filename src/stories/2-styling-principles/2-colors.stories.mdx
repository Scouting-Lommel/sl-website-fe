...
<Meta title="2. Styling principles / 2.2 Colors" />
    ...
    <section className="sb-col-page">
      <div className="sb-section">
        <h2 className="sb-heading__2" id="primary">Primary</h2>
      ...
      <div className="sb-section">
        <h2 className="sb-heading__2" id="secondary">Secondary</h2>
        ...
        <div className="sb-list__item">
          ...
          <div className="sb-code">`#f2ce7b`</div>
        </div>
        ...
        <div className="sb-list__item">
          ...
          <div className="sb-code">`#faeac6`</div>
        </div>
      ...
      <div className="sb-section">
        <h2 className="sb-heading__2" id="neutral">Neutral</h2>
      ...
      <div className="sb-section">
        <h2 className="sb-heading__2" id="whites">Whites</h2>
